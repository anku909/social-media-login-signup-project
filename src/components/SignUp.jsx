...
function SignUp() {
  ...
  return (
    <>
      <div className="signUp w-full h-screen px-[25vw] bg-slate-200 ">
        <div className="singUp-inner-section w-full h-screen pt-4 flex items-center justify-center">
          <div className="SignUp-function-section w-[30vw] h-5/6  px-12  flex flex-col">
            <div className="signUp-box w-full h-full border-[1px] border-[#a8a8a8]">
              <div className="heading w-full pt-4 mb-8">
                <h1 className="heading-text text-4xl text-center font-semibold font-mono">
                  Social Media
                </h1>
              </div>
              <div className="signUp-details-section w-full h-[32vh]mt-2 px-20 flex flex-col items-center gap-4 relative ">
                <form
